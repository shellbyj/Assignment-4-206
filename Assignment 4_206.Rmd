...
lobster_aov <- aov.test(SIZE ~ SITE, data = lobster17)
lobster_sum <- summary(lobster_aov)

lobster_aov

post_hoc <- paircomp(lobster_aov, adjust.method = "bonferroni")

## ANOVA revealed that there is a significant difference in means across the sites and the post-hoc clarified that means differ between 3 pairs of sites (NAPL/MOHK, NAPL/IVEE, NAPL/CARP)
